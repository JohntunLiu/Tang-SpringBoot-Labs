...
public class UserController {
    ...
    public Flux<UserVO> list() {
        ...
        result.add(new UserVO().setId(1).setUsername("yudaoyuanma1"));
        result.add(new UserVO().setId(2).setUsername("woshiyutou1"));
        result.add(new UserVO().setId(3).setUsername("chifanshuijiao1"));
        // 返回列表
