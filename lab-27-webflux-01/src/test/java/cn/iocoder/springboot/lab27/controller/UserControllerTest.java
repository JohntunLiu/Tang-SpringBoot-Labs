package cn.iocoder.springboot.lab27.controller;
...
@SpringBootTest(classes = cn.iocoder.springboot.lab27.springwebflux.Application.class)
    ...
    public void testList() {
        webClient.get().uri("/users/list")
                ...
                .expectBody().json("[\n" +
                        "    {\n" +
                        "        \"id\": 1,\n" +
                        "        \"username\": \"yudaoyuanma1\"\n" +
                        "    },\n" +
                        "    {\n" +
                        "        \"id\": 2,\n" +
                        "        \"username\": \"woshiyutou1\"\n" +
                        "    },\n" +
                        "    {\n" +
                        "        \"id\": 3,\n" +
                        "        \"username\": \"chifanshuijiao1\"\n" +
                        "    }\n" +
                        "]"); // 响应结果
    }
